...
// agregar producto
                ...
                if (numeroProduto > 0 && numeroProduto <= Datos.nombres.length) {
                    if (cantidad > 0) {
...
// agrega al pedido
                        Datos.cantidades[numeroProduto - 1] = Datos.cantidades[numeroProduto - 1] + cantidad;
                        System.out.println("Producto agregado al pedido.");
                        System.out.println("  -> " + Datos.nombres[numeroProduto - 1] + " x" + cantidad);
                        NumeroMesa = Datos.precios[numeroProduto - 1] * cantidad;
                    } else {
                        if (cantidad == 0) {
// cantidad es cero
